...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Dashboard IoT de monitoramento de incêndios com sensores simulados, MQTT e NASA FIRMS." },
      { name: "author", content: "SENTINELA" },
      { property: "og:title", content: "SENTINELA — Monitoramento de Incêndios Florestais" },
      { property: "og:description", content: "Dashboard IoT de monitoramento de incêndios com sensores simulados, MQTT e NASA FIRMS." },
